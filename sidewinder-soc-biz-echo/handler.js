...
const {BotBusinessLogicXRPLAlerts} = require("./BotBusinessLogicXRPLAlerts");
...
module.exports.process = async event => {
    ...
    const botBusinessLogic = new BotBusinessLogicXRPLAlerts(configResponse.data, twitterResponderClient);
