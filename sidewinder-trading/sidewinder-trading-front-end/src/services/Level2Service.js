        ...
        return new Promise(async (resolve) => {
            try {
                ...
                const result = await axios.get(
                    'https://trading-api.payburner.com/venues/' + venueId + '/level2/instance',
                    {
                        headers: {
                ...
                console.log(
                    'Level2 Instances ERROR:' + JSON.stringify(error.response.data, null,
